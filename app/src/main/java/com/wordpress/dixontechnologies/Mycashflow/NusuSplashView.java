 ...
 *
 */
public class NusuSplashView extends View {

    private static final String TAG = "NusuSplashView";
     ...
     * @param context
     */
    public NusuSplashView(Context context){
        super(context);
        initialize();
    }
     ...
     * @param attrs
     */
    public NusuSplashView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();
     ...
     * @param attrs
     */
    public NusuSplashView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.__NusuNusuSplashView__);

        int numAttrs = a.getIndexCount();
        for (int i = 0; i < numAttrs; ++i) {
            int attr = a.getIndex(i);
            switch (attr) {
                case R.styleable.__NusuNusuSplashView___removeFromParentOnEnd:
                    setRemoveFromParentOnEnd(a.getBoolean(i, DEFAULT_REMOVE_FROM_PARENT_ON_END));
                    break;
                case R.styleable.__NusuNusuSplashView___circleRadius:
                    setCircleRadius(a.getDimensionPixelSize(i, DEFAULT_CIRCLE_RADIUS));
                    break;
                case R.styleable.__NusuNusuSplashView___rotationRadius:
                    setRotationRadius(a.getDimensionPixelSize(i, DEFAULT_ROTATION_RADIUS));
                    break;
                case R.styleable.__NusuNusuSplashView___rotationDuration:
                    setRotationDuration(a.getInteger(i, DEFAULT_ROTATION_DURATION));
                    break;
                case R.styleable.__NusuNusuSplashView___splashBackgroundColor:
                    setSplashBackgroundColor(a.getColor(i, DEFAULT_SPLASH_BG_COLOR));
                    break;
                case R.styleable.__NusuNusuSplashView___splashDuration:
                    setSplashDuration(a.getInteger(i, DEFAULT_SPLASH_DURATION));
                    break;
                case R.styleable.__NusuNusuSplashView___circleColors:
